...
class Synthesis(nn.Module):
    ...
    # def forward(self, wa, alpha, feats, target_feats):
        ...
        if alpha is not None:
            ...
            if len(alpha) > 1:
                # print(len(alpha), alpha[0].shape, alpha[1].shape, alpha[2].shape, '1')
                ...
                # print(len(alpha), alpha[0].shape, '2')
